...
public class SkillController {
    ...
    public List<Skill> getAll(@RequestParam(value = "language", defaultValue = "en") String language)
        ...
        File file;
        file = ResourceUtils.getFile("classpath:api/" + language + "/skill.json");
        InputStream is = new FileInputStream(file);
        final List<Skill> result = mapper.readValue(is,
                TypeFactory.defaultInstance().constructCollectionType(List.class, Skill.class));
        return result;
    }
